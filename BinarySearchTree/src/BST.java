...
public void breadthFirstTraversal ()
  {
	  ...
	  while(!bFT.isEmpty())
	  {
		  current = (TreeNode<E>) bFT.remove();
		  System.out.print(current.element + " ");
		  if(current.left!=null)bFT.add(current.left);
		  if(current.right!=null)bFT.add(current.right);
	  } 
 ...
 ****************************************/  
  ...
  public int height()
  {
	  ...
	  count++;
	  count += Math.max(getHeight(current.left), getHeight(current.right));
  ...
  public int getHeight(TreeNode<E> a){
	  if(a==null)
		  ...
		  return 1 + getHeight(a.left) + getHeight(a.right);
  ...
  public int getNumberOfNonLeaves()
  {
	  ...
	  if(current==null)
		  return 0;
	  count++;
	  count += findLeaf(current.left) + findLeaf(current.right);
  ...
  public int findLeaf(TreeNode<E> e){
	  if(e==null)
		  ...
		  return 1 + findLeaf(e.left) + findLeaf(e.right);
